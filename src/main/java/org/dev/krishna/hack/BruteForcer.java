package com.spring1.bruteforce;
...
public class BruteForcer {
    ...
    public static void main(String[] args) {
        BruteForcer alphaBruteForcer = BruteForcer.createAlphaBruteForcer();
        System.out.println(alphaBruteForcer.computeNextCombination());
    }
